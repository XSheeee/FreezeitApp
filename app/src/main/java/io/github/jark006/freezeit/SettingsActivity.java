...
public class SettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Spinner clusterBindSpinner, freezeModeSpinner, reFreezeTimeoutSpinner, wakeupTimeoutSpinner;
    SeekBar freezeTimeoutSeekbar, terminateTimeoutSeekbar;
    TextView freezeTimeoutText, terminateTimeoutText;
    ...
    public void onResume() {
        ...
        new Thread(() -> {
            ...
            if (settingsVar[clusterBindIdx] > 5) settingsVar[clusterBindIdx] = 0;
            if (settingsVar[freezeModeIdx] > 5) settingsVar[freezeModeIdx] = 2;
            if (settingsVar[reFreezeTimeoutIdx] > 4) settingsVar[reFreezeTimeoutIdx] = 0;
